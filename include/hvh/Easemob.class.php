	...
	*/
	...
	/*
		...
		可能的错误码：
			...
			401（未授权[无token、token错误、token过期]、5xx。详见：服务器端 REST API 常见错误码
		查询的时间格式为10位数字形式(YYYYMMDDHH),例如要查询2016年12月10号7点到8点的历史记录，
