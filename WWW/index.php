...
This file will be overwritten when WTServer is updated!
/////////////////////////////////////////////////////
...
You can find examples of this 2 files in WTServer\src
...
if (isset($_GET['errorLog'])) {
	...
	$extra.="<div id='errorLog'>";
	$extra.="<h4>Last 30 errors from $log:</h4>";
...
<!DOCTYPE html><html>
<head>
	<title>WTServer (wt-nmp) - portable Nginx MariaDB Redis Php development stack for Windows</title>
...
<table id="foot" width="100%" border="0" cellspacing="0" cellpadding="0"><tr>
		<th><a href="http://wtserver.wtriple.com/" title="WTServer (wt-nmp) development stack"><img src="tools/wtripleLogo48.png" /></a></th>
		...
		<td><a href="http://wtserver.wtriple.com/" title="WTServer (wt-nmp) Official Website">WTServer Docs</a></td>
		...
		<td><a href="http://hosting.wtriple.com/" title="Benefit from the same straightforward aproach of WTServer (wt-nmp), on our Linux Managed Nginx hosting servers"><b>Nginx Hosting</b></a></td>
		<td>$nginxVersion</td>
